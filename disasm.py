...
def disasm_one(s: ConstBitStream) -> bpf.Instruction:
    ...
    src_reg = s.read("u4")
    dst_reg = bpf.Register(s.read("u4"))
    ...
    if ins_class.is_alu():
        ...
        ins = bpf.Alu(opcode, bpf.Register(src_reg), dst_reg, offset, imm)
        ...
        ins = bpf.Jump(opcode, bpf.Register(src_reg), dst_reg, offset, imm)
        ...
        if ins_class == bpf.InsClass.LD:
            ...
            ins = bpf.LoadStore(opcode, bpf.Register(src_reg), dst_reg, offset, imm)
    else:
